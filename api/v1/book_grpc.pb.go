...
type BookServiceClient interface {
	...
	RetrieveBook(ctx context.Context, in *RetrieveBookRequest, opts ...grpc.CallOption) (*RetrieveBookRessponse, error)
...
func (c *bookServiceClient) RetrieveBook(ctx context.Context, in *RetrieveBookRequest, opts ...grpc.CallOption) (*RetrieveBookRessponse, error) {
	out := new(RetrieveBookRessponse)
...
type BookServiceServer interface {
	...
	RetrieveBook(context.Context, *RetrieveBookRequest) (*RetrieveBookRessponse, error)
...
func (UnimplementedBookServiceServer) RetrieveBook(context.Context, *RetrieveBookRequest) (*RetrieveBookRessponse, error) {
